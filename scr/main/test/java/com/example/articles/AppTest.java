...
public class AppTest {
    ...
    public void testE2EFlow() {
        ...
        HttpResponse<JsonNode> deleteCommentResponse = Unirest.delete("http://localhost:4567/comments/" + commentId).asJson();
        assertEquals(200, deleteCommentResponse.getStatus());

        HttpResponse<JsonNode> getArticleResponse = Unirest.get("http://localhost:4567/articles/" + articleId).asJson();
